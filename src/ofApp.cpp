...
void ofApp::setup(){
    ...
    */
    ...
    SoundManager::loadSong("Sakuya Izayoi", "Sounds/SakuyaOST.mp3");
...
void ofApp::draw(){
    currentState->draw();
    ofDrawBitmapString(ofToString(ofGetMouseX()), 110, 30);
    ofDrawBitmapString(ofToString(ofGetMouseY()), 110, 50);

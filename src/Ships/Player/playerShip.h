...
class Player{ 
    ...
    // === Attributes related to movement ===
        ...
        float sprintMultiplier = 1.5;// number that accelerationAmount is going to get multiplied by
    ...
    public: 
       ...
       // === Public attributes ===
        ...
        bool hasShield = false; //Boolean for Shield
        bool immunity = false;
        bool hasBomb = false;
        bool Kaboom = false;
    ...
    // Main method to draw the playerShip
        ...
        ofImage getShield(){return shipShield;}
        ofImage get2ndSprite(){return secondShipSprite;}
    /*
    ...
    */
    ...
    // === Input handling ===
        ...
        void holdSprint(bool enableSprint);    // Function that will handle the movement for the ship
    // stats reset 
